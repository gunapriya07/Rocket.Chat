...
const settingsPublicResponseSchema = ajv.compile({
	type: 'object',
	properties: {
...
const settingsOAuthResponseSchema = ajv.compile({
	type: 'object',
	properties: {
...
const settingsListResponseSchema = ajv.compile({
	type: 'object',
	properties: {
		settings: { type: 'array', items: { type: 'object' } },
		count: { type: 'number' },
...
const settingByIdGetResponseSchema = ajv.compile({
	type: 'object',
	properties: {
		_id: { type: 'string' },
		value: {},
...
const settingByIdPostResponseSchema = ajv.compile({
	type: 'object',
...
const serviceConfigurationsResponseSchema = ajv.compile({
	type: 'object',
	properties: {
...
API.v1.get(
	...
	async function action() {
		...
		return API.v1.success({ ..._.pick(setting, '_id', 'value'), success: true });
	},
);
